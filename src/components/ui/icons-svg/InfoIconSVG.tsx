...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,256,256" width="52px" height="52px">
  <g fill="#D9D9D9" fillRule="nonzero" stroke="#D9D9D9" strokeWidth="2" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{ mixBlendMode: 'normal' }}>
